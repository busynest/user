...
import { application, auth, db, storage }        from '../../firebase/authentication';
...
export class ProtoPhoto extends connect(store)(LitElement) {
...
customElements.define('proto-photo', ProtoPhoto);

declare global {
  interface HTMLElementTagNameMap {
      'proto-photo': ProtoPhoto;
  }
}
